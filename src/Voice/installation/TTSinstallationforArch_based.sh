...
echo "installation of dependencies for Text-To-Speech was finished. To test if it is working, execute modeltest.py after the other parts are installed. (src/Voice/uitls/modeltest.py)"